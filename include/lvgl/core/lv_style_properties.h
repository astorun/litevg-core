...
enum _lv_property_style_id_t {
    ...
    LV_PROPERTY_ID(STYLE, BG_DITHER,                LV_PROPERTY_TYPE_INT,        LV_STYLE_BG_DITHER),
    ...
    LV_PROPERTY_ID(STYLE, BLUR_DITHER,              LV_PROPERTY_TYPE_INT,        LV_STYLE_BLUR_DITHER),
    ...
    LV_PROPERTY_ID(STYLE, DROP_SHADOW_DITHER,       LV_PROPERTY_TYPE_INT,        LV_STYLE_DROP_SHADOW_DITHER),
    ...
    LV_PROPERTY_ID(STYLE, SHADOW_DITHER,            LV_PROPERTY_TYPE_INT,        LV_STYLE_SHADOW_DITHER),
