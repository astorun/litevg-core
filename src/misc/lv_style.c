...
const uint8_t lv_style_builtin_prop_flag_lookup_table[LV_STYLE_NUM_BUILT_IN_PROPS] = {
    ...
    [LV_STYLE_SHADOW_DITHER] =             LV_STYLE_PROP_FLAG_EXT_DRAW_UPDATE,
    ...
    [LV_STYLE_DROP_SHADOW_DITHER] =        LV_STYLE_PROP_FLAG_EXT_DRAW_UPDATE,
    [LV_STYLE_BLUR_DITHER] =               LV_STYLE_PROP_FLAG_EXT_DRAW_UPDATE,
